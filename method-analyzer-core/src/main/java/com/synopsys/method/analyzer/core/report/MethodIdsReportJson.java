...
/**
 * Represents full JSON contents for a report on the identifiers of multiple methods referenced within an analyzed
 * project
 *
 * <p>
...
public final class MethodIdsReportJson {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof MethodIdsReportJson) {
            MethodIdsReportJson compare = (MethodIdsReportJson) obj;

            result = Objects.equals(compare.getMethodIds(), getMethodIds());
        }
